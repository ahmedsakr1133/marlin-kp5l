...
#define CUSTOM_MACHINE_NAME "KP5L"
...
//#define MPCTEMP         // ** EXPERIMENTAL ** See https://marlinfw.org/docs/features/model_predictive_control.html	// GR MPC solo per termistore inox
...
#define DEFAULT_EJERK    10.0  // May be used by Linear Advance // GR Linear advance vuole almeno 10 era 5
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 5    // Don't use more than 7 points per axis, implementation limited. // GR 4x4 punti di calibrazione manuale
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X
